...
namespace TRexGame.Entities
{
    ...
    {
        private const float RUN_ANIMATION_FRAME_LENGTH = 0.1f;  // Per second
        ...
        private const float BLINK_ANIMATION_EYE_CLOSED_TIME = 0.5f;
        ...
        private const int TREX_RUNNING_SPRITE_TWO_POS_X = TREX_DEFAULT_SPRITE_POS_X + (TREX_DEFAULT_SPRITE_WIDTH * 3);
        ...
        private const int TREX_DUCKING_SPRITE_TWO_POS_X = TREX_DEFAULT_SPRITE_POS_X + (TREX_DEFAULT_SPRITE_WIDTH * 6) + TREX_DUCKING_SPRITE_WIDTH;
        private const int TREX_DUCKING_SPRITE_TWO_POS_Y = 0;
        private const int TREX_DUCKING_SPRITE_WIDTH = 59;
        private const int TREX_DUCKING_SPRITE_HEIGHT = TREX_DEFAULT_SPRITE_HEIGHT;

        private const int TREX_DEAD_SPRITE_POS_X = 1068;
        private const int TREX_DEAD_SPRITE_POS_Y = 0;

        private const int DROP_VELOCITY = 600;

        public const float START_SPEED = 280f;
        public const float MAX_SPEED = 900;
        ...
        public Trex(Texture2D spriteSheet, Vector2 position, SoundEffect jumpSound)
        {
            ...
            _runAnimation.AddFrame(new Sprite(spriteSheet, TREX_RUNNING_SPRITE_TWO_POS_X, TREX_RUNNING_SPRITE_TWO_POS_Y, TREX_DEFAULT_SPRITE_WIDTH, TREX_DEFAULT_SPRITE_HEIGHT), RUN_ANIMATION_FRAME_LENGTH);
            ...
            _duckAnimation.AddFrame(new Sprite(spriteSheet, TREX_DUCKING_SPRITE_TWO_POS_X, TREX_DUCKING_SPRITE_TWO_POS_Y, TREX_DUCKING_SPRITE_WIDTH, TREX_DUCKING_SPRITE_HEIGHT), RUN_ANIMATION_FRAME_LENGTH);
            _duckAnimation.AddFrame(_runAnimation[0].Sprite, RUN_ANIMATION_FRAME_LENGTH * 2);
            _duckAnimation.Play();
        ...
        private void CreateBlinkAnimation()
        {
            ...
            _blinkAnimation.AddFrame(_idleSprite, (float)blinkTimeStamp + BLINK_ANIMATION_EYE_CLOSED_TIME);
        }
